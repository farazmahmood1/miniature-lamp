 ...
 *
 * InteractionRuntime can already drive a carousel, but only from a list of captured per-index
...
export default function CaseStudyCarousel() {
  useEffect(() => {
    ...
    for (const tile of tiles) {
      ...
      let index = 0;
      // Below lg the arrows are hidden and motion.css hands the track to native scroll
