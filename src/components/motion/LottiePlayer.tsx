 ...
 * 542 frames, 47 layers) into `public/assets/site/lottie/`, but the generator also
...
export default function LottiePlayer({ src, cid, className, posterFrame = 120 }: Props) {
