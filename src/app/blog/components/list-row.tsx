...
export default function ListRow({ d, styles }: { d: ListRowData; styles: ListRowStyles }) {
  return (
    <li className="block">
      <a className={cn("h-13.5 inline-flex py-2.5 items-center cursor-pointer", styles.className)} data-component="link" href={d.href} target={d.target} aria-current={d.ariacurrent}>
        {" "}
