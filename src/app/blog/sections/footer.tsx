    ...
    <footer className="block relative -mt-7.5 pt-7.5 text-background">
      <div className="block relative">
        <div className="flex relative z-1 max-w-500 pt-10 px-10 flex-col gap-30 max-lg:pt-7 max-lg:px-[0.9375rem] max-lg:gap-12">
              ...
              <div className="flex flex-col gap-6 col-start-[span_2] col-end-[span_2]">
                ...
                <div className="block">
                  <div className="flex flex-wrap gap-4">
                    ...
                    <div className="block">
                      <a className="h-13.5 min-h-13.5 inline-flex relative isolate px-5 rounded-[7px] justify-center items-center gap-2 overflow-hidden bg-clr-2 [backdrop-filter:blur(16px)] cursor-pointer max-lg:h-10.5 max-lg:min-h-10.5 max-lg:px-3.5" data-component="link" href="/book-demo" target="_self">
                        {" "}
          ...
          {" "}
          <div className="border-t border-solid border-t-clr-3 grid py-7.5 gap-5 grid-cols-12 max-lg:items-end max-lg:gap-y-2 max-lg:gap-x-[0.9375rem] max-md:grid-cols-2">
