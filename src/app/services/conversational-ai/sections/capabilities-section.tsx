...
import { Logo_meta } from "../node-meta";
import { Logo_styles, MediaCard_styles } from "../node-styles";
import { listRow2Data as listRow2DataContent, cards as cardsContent } from "../content";
import VoiceVisualizer from "../../../components/voice-visualizer";
const Logo_data: LogoData[] = [
    { ariahidden: "true", style: { maskImage: "url(\"/assets/conversational-ai/svg/4417c17ef015.svg\")" }, height: "24", imgSrc: "/assets/conversational-ai/svg/4417c17ef015.svg", width: "81" },
    { ariahidden: "true", style: { maskImage: "url(\"/assets/conversational-ai/images/2752282a18c7.png\")" }, height: "269", imgSrc: "/assets/conversational-ai/images/2752282a18c7.png", width: "1280" },
    { style: { maskImage: "url(\"/assets/conversational-ai/svg/22ef432010b6.svg\")" }, height: "28", imgSrc: "/assets/conversational-ai/svg/22ef432010b6.svg", width: "123" },
    { style: { maskImage: "url(\"/assets/conversational-ai/svg/5cc158def43b.svg\")" }, height: "80", imgSrc: "/assets/conversational-ai/svg/5cc158def43b.svg", width: "80" },
    { style: { maskImage: "url(\"/assets/conversational-ai/svg/c2ff037e4dc4.svg\")" }, height: "33", imgSrc: "/assets/conversational-ai/svg/c2ff037e4dc4.svg", width: "146" },
    { style: { maskImage: "url(\"/assets/conversational-ai/svg/87722bcc21a1.svg\")" }, height: "59", imgSrc: "/assets/conversational-ai/svg/87722bcc21a1.svg", width: "317" },
    { style: { maskImage: "url(\"/assets/conversational-ai/images/2752282a18c7.png\")" }, height: "269", imgSrc: "/assets/conversational-ai/images/2752282a18c7.png", width: "1280" },
    { style: { maskImage: "url(\"/assets/conversational-ai/svg/4417c17ef015.svg\")" }, height: "24", imgSrc: "/assets/conversational-ai/svg/4417c17ef015.svg", width: "81" },
    { ariahidden: "true", style: { maskImage: "url(\"/assets/conversational-ai/svg/22ef432010b6.svg\")" }, height: "28", imgSrc: "/assets/conversational-ai/svg/22ef432010b6.svg", width: "123" },
    { ariahidden: "true", style: { maskImage: "url(\"/assets/conversational-ai/svg/5cc158def43b.svg\")" }, height: "80", imgSrc: "/assets/conversational-ai/svg/5cc158def43b.svg", width: "80" }
];
/** The Conversational AI page body: hero, capability blocks and case studies. */
export default function CapabilitiesSection({ listRow2Data = listRow2DataContent, logoData = Logo_data, cards = cardsContent } = {}) {
  return (
      ...
      <div className="block">
        <div className="block">
          <c-hero-use-case class="block relative pb-[7.05rem] text-background max-md:pb-26 md:max-lg:pb-[6.7375rem] 2xl:pb-[7.45rem]" id="herousecase-42">
                ...
                <div className="min-h-100 grid pb-[78.1px] gap-y-[2.55rem] gap-x-5 grid-cols-12 max-md:min-h-101.5 max-md:pb-10 max-md:gap-y-8 max-lg:gap-x-[0.9375rem] max-md:grid-cols-1 md:max-lg:min-h-128 md:max-lg:pb-[46.3px] md:max-lg:gap-y-9 2xl:min-h-135 2xl:pb-[5.875rem] 2xl:gap-y-[2.95rem]">
                  <div className="block col-start-1 col-end-7 max-md:[grid-column-start:initial] max-md:[grid-column-end:initial]">
                    <c-split-title class="inline" id="splittitle-55">
                      {" "}
                      <div className="block font-favorit text-[5rem] font-light leading-[5rem] tracking-[-2px] max-md:text-[2.8125rem] max-md:leading-[2.8125rem] max-md:tracking-[-1.12px] md:max-lg:text-6xl md:max-lg:leading-[3.75rem] md:max-lg:tracking-[-1.49px] 2xl:text-[6.5625rem] 2xl:leading-[6.5625rem] 2xl:tracking-[-2.62px]" data-component="heading" aria-label="Agents that answer, qualify and book calls">
                    ...
                    <div className="w-full max-w-100 flex flex-col gap-7.5">
                      <div className="block max-w-[66.8rem] leading-7 text-balance">
                        <p className="block text-[1.0625rem] font-normal leading-[1.4375rem] tracking-[0.17px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:leading-[1.375rem] max-lg:tracking-[0.16px] max-lg:[font-size:inherit]">
                          Phone, web and WhatsApp assistants that carry a conversation to a booked meeting or a clean handoff, fast enough that nobody waits for the beep.
                        </p>
                      </div>
                      {" "}
                      <div className="flex flex-wrap gap-4">
                        <div className="block">
                          <a className="h-13.5 min-h-13.5 inline-flex relative isolate px-5 rounded-[7px] justify-center items-center gap-2 overflow-hidden text-color-001 bg-primary cursor-pointer max-lg:h-10.5 max-lg:min-h-10.5 max-lg:px-3.5" data-component="link" href="/contact" target="_self">
                            {" "}
            ...
            {" "}
            <div className="block max-w-500 px-10 max-lg:px-[0.9375rem]">
              <VoiceVisualizer className="h-[299.5px] flex justify-between max-md:h-50 md:max-lg:h-[242.3px] 2xl:h-[23.1875rem]" />
              {" "}
            </div>
            {" "}
          </c-hero-use-case>
              ...
              <div className="block max-w-500 px-10 max-lg:px-[0.9375rem]">
                <div className="grid mb-[7.5625rem] gap-5 grid-cols-2 max-lg:hidden 2xl:mb-[150.3px]">
                  <div className="block max-w-120 text-balance">
                    <p className="block text-[1.625rem] font-normal leading-[2.1875rem] tracking-[-0.64px] 2xl:text-3xl 2xl:leading-[2.5rem] 2xl:tracking-[-0.74px]">
                      Tuned until the latency stops being the thing people notice.
                    </p>
                    {" "}
                  </div>
                  {" "}
                  <div className="block">
                    <c-split-title class="inline" id="splittitle-56">
                      {" "}
                      <div className="block -mt-[0.425rem] font-favorit text-[4.25rem] font-light leading-[4.4375rem] tracking-[-1.69px] 2xl:-mt-[0.55rem] 2xl:text-[5.5rem] 2xl:leading-[5.75rem] 2xl:tracking-[-2.19px]" aria-label="Why Codilated for voice">
                        <div className="inline-block relative" aria-hidden="true">
                          Why
                        </div>
                        {" "}
                ...
                <c-feature-cards class="grid mb-[78.1px] gap-5 grid-cols-[590px_590px] max-md:mb-14 max-lg:gap-[0.9375rem] max-md:grid-cols-[345px] md:max-lg:mb-[4.0875rem] md:max-lg:grid-cols-[738px] 2xl:mb-[5.875rem] 2xl:grid-cols-[910px_910px]" id="featurecards-54">
                  <div className="block">
                    <div className="h-[15.7875rem] block sticky top-24.5 max-lg:h-auto max-lg:static max-lg:top-auto 2xl:h-[305.7px]">
                      <h2 className="flex mb-12.5 items-center gap-2 max-lg:mb-6" data-component="heading">
                        ...
                        {" "}
                        <span className="block font-suisse-mono text-[0.8125rem] font-normal leading-3.5 tracking-[-0.32px] uppercase" data-node-id="motion-span">
                          {" What you get "}
                        </span>
                        {" "}
                      </h2>
                      ...
                      <div className="hidden mb-[78.1px] max-lg:block max-md:mb-14 md:max-lg:mb-[4.0875rem]">
                        <c-split-title class="inline" id="splittitle-57">
                          {" "}
                          <div className="block font-favorit text-[4.25rem] font-light leading-[4.4375rem] tracking-[-1.69px] max-md:text-[2.5rem] max-md:leading-10.5 max-md:tracking-[-1px] md:max-lg:text-[3.25rem] md:max-lg:leading-[3.375rem] md:max-lg:tracking-[-1.29px]" aria-label="Why Codilated for voice">
                            <div className="inline-block relative" aria-hidden="true">
                              Why
                            </div>
                            {" "}
                  ...
                  <div className="grid gap-[78.1px] grid-cols-1 max-w-3xl max-md:gap-14 md:max-lg:gap-[4.0875rem] 2xl:gap-[5.875rem]">
                    <div className="block" id="latency">
                        ...
                        <div className="flex pr-[88.5px] flex-col gap-4 max-md:pr-0 md:max-lg:pr-[13.8375rem] 2xl:pr-[7.2rem]">
                          ...
                          <div className="block max-w-[66.8rem] leading-7">
                            <p className="block text-lg font-normal leading-[1.6875rem] tracking-[0.18px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:text-[1.0625rem] max-lg:leading-[1.625rem] max-lg:tracking-[0.17px]">
                              We budget the whole round trip and overlap the stages: retrieval starts on the partial transcript, synthesis starts on the first clause. Voice selection comes after that, not before.
                            </p>
                          </div>
                          {" "}
                          <div className="flex flex-wrap gap-4" />
                    ...
                    <div className="block" id="grounded-answers">
                        ...
                        <div className="flex pr-[88.5px] flex-col gap-4 max-md:pr-0 md:max-lg:pr-[13.8375rem] 2xl:pr-[7.2rem]">
                          ...
                          <div className="block max-w-[66.8rem] leading-7">
                            <p className="block text-lg font-normal leading-[1.6875rem] tracking-[0.18px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:text-[1.0625rem] max-lg:leading-[1.625rem] max-lg:tracking-[0.17px]">
                              ...
                              <span className="inline" />
                              <span className="inline">
                                Retrieval over your own documents, with citations, so the agent answers from what you actually published rather than from a confident guess.
                              </span>
                            </p>
                          </div>
                          {" "}
                    ...
                    <div className="block" id="real-actions">
                        ...
                        <div className="flex pr-[88.5px] flex-col gap-4 max-md:pr-0 md:max-lg:pr-[13.8375rem] 2xl:pr-[7.2rem]">
                          ...
                          <div className="block max-w-[66.8rem] leading-7">
                            <p className="block text-lg font-normal leading-[1.6875rem] tracking-[0.18px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:text-[1.0625rem] max-lg:leading-[1.625rem] max-lg:tracking-[0.17px]">
                              ...
                              <span className="inline" />
                              <span className="inline">
                                Checking availability, booking the slot, updating the record and sending the confirmation, in your calendar and your CRM, before the call ends.
                              </span>
                            </p>
                          </div>
                          {" "}
                    ...
                    <div className="block" id="handoff">
                      <c-feature-card-logo-carousel class="flex flex-col gap-6" id="featurecardlogocarousel-52">
                        ...
                        <div className="flex pr-[88.5px] flex-col gap-4 max-md:pr-0 md:max-lg:pr-[13.8375rem] 2xl:pr-[7.2rem]">
                          ...
                          <div className="block max-w-[66.8rem] leading-7">
                            <p className="block text-lg font-normal leading-[1.6875rem] tracking-[0.18px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:text-[1.0625rem] max-lg:leading-[1.625rem] max-lg:tracking-[0.17px]">
                              When a conversation should reach a person it transfers with the full transcript and the agent's read of the situation, so nobody starts the conversation over.
                            </p>
                          </div>
                          {" "}
                          <div className="flex flex-wrap gap-4">
              ...
              <div className="block max-w-500 mb-[3.4375rem] px-10 max-md:mb-10 max-lg:px-[0.9375rem] md:max-lg:mb-[46.3px] 2xl:mb-[65.7px]">
                <div className="flex flex-col gap-12.5">
                  <c-split-title class="block" id="splittitle-58">
                    <div className="block font-favorit text-[4.25rem] font-light leading-[4.4375rem] tracking-[-1.69px] max-md:text-[2.5rem] max-md:leading-10.5 max-md:tracking-[-1px] md:max-lg:text-[3.25rem] md:max-lg:leading-[3.375rem] md:max-lg:tracking-[-1.29px] 2xl:text-[5.5rem] 2xl:leading-[5.75rem] 2xl:tracking-[-2.19px]" data-node-id="motion-examples" aria-label="Examples">
                      <div className="inline-block relative" aria-hidden="true">
                        Examples
                      </div>
                    </div>
                  ...
                  <c-carousel-tile class="block relative z-1" id="carouseltile-53">
                    <div className="flex mb-[2.55rem] justify-between items-center max-md:mb-8 md:max-lg:mb-9 2xl:mb-[2.95rem]">
                      ...
                      <div className="block max-lg:hidden">
                        <button className="inline-flex relative opacity-50 isolate rounded-[7px] justify-center items-center gap-2 overflow-hidden text-center bg-background cursor-pointer h-[3.375rem] w-[3.375rem] max-lg:h-[2.625rem] max-lg:w-[2.625rem]" data-node-id="interaction-previous-slide" data-component="button" aria-label="Previous slide" disabled type="button">
                          {" "}
                        ...
                        {" "}
                        <button className="inline-flex relative isolate rounded-[7px] justify-center items-center gap-2 overflow-hidden text-center bg-background cursor-pointer h-[3.375rem] w-[3.375rem] max-lg:h-[2.625rem] max-lg:w-[2.625rem]" data-node-id="interaction-next-slide" data-component="button" aria-label="Next slide" type="button">
                          {" "}
                    ...
                    {" "}
                    <div className="box-content flex relative z-1 items-stretch" data-node-id="interaction-div">
                        ...
                        <div className="flex relative flex-col h-full">
                          ...
                          <div className="flex relative z-2 p-5 justify-center items-center overflow-hidden aspect-[464/392]">
                            ...
                            <div className="w-1/2 h-[144.7px] block relative max-md:h-[95.3px] max-md:w-auto md:max-lg:h-[132.7px] 2xl:h-[14.675rem]">
                              <div className="h-full block bg-foreground" style={{ maskImage: "url(\"/assets/conversational-ai/images/0fcf43eceab2.avif\")" }} aria-hidden="true" />
                              {" "}
                      ...
                      <div className="w-97.5 block relative mr-[0.9375rem] shrink-0 max-md:w-[17.0625rem] md:max-lg:w-[361.5px] 2xl:w-[603.3px]">
                        <div className="flex relative flex-col h-full">
                          ...
                          <div className="flex relative z-2 p-5 flex-col justify-between grow gap-3.5">
                            <h3 className="block text-[1.625rem] font-normal leading-[2.1875rem] tracking-[-0.64px] max-md:text-xl max-md:leading-[1.6875rem] max-md:tracking-[-0.5px] md:max-lg:text-[1.375rem] md:max-lg:leading-[1.875rem] md:max-lg:tracking-[-0.56px] 2xl:text-3xl 2xl:leading-[2.5rem] 2xl:tracking-[-0.74px]" data-component="heading" aria-hidden="true">
                              {" A voice agent that books appointments without sounding like one "}
                            </h3>
                            {" "}
                            <div className="flex justify-between items-center">
                              <span className="block text-muted-foreground text-[0.9375rem] font-normal leading-[1.25rem] tracking-[0.15px] max-lg:text-sm max-lg:leading-[1.125rem] max-lg:tracking-[0.14px]">
                          ...
                          {" "}
                          <a className="h-full block absolute top-0 inset-x-0 z-3 min-w-0 rounded-[10px] cursor-pointer" data-component="link" href="/work/meridian-health-intake-agent">
                            {" "}
                            <span className="w-px h-px block absolute -m-px overflow-hidden whitespace-nowrap text-nowrap [clip-path:inset(50%)]">
                              {" A voice agent that books appointments without sounding like one "}
                            </span>
                      ...
                      <div className="w-97.5 block relative mr-[0.9375rem] shrink-0 max-md:w-[17.0625rem] md:max-lg:w-[361.5px] 2xl:w-[603.3px]">
                        <div className="flex relative flex-col h-full">
                          ...
                          <div className="flex relative z-2 p-5 flex-col justify-between grow gap-3.5">
                            <h3 className="block text-[1.625rem] font-normal leading-[2.1875rem] tracking-[-0.64px] max-md:text-xl max-md:leading-[1.6875rem] max-md:tracking-[-0.5px] md:max-lg:text-[1.375rem] md:max-lg:leading-[1.875rem] md:max-lg:tracking-[-0.56px] 2xl:text-3xl 2xl:leading-[2.5rem] 2xl:tracking-[-0.74px]" data-component="heading" aria-hidden="true">
                              {" Cutting freight quote turnaround from two days to eleven minutes "}
                            </h3>
                            {" "}
                            <div className="flex justify-between items-center">
                              <span className="block text-muted-foreground text-[0.9375rem] font-normal leading-[1.25rem] tracking-[0.15px] max-lg:text-sm max-lg:leading-[1.125rem] max-lg:tracking-[0.14px]">
                          ...
                          {" "}
                          <a className="h-full block absolute top-0 inset-x-0 z-3 min-w-0 rounded-[10px] cursor-pointer" data-component="link" href="/work/northwind-logistics-quote-automation">
                            {" "}
                            <span className="w-px h-px block absolute -m-px overflow-hidden whitespace-nowrap text-nowrap [clip-path:inset(50%)]">
                              {" Cutting freight quote turnaround from two days to eleven minutes "}
                            </span>
