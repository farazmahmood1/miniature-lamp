...
const MediaCard_data: MediaCardData[] = [
    { ariahidden: "true", style: { maskImage: "url(\"/assets/custom-ai-development/svg/c73fb6786013.svg\")" }, height: "46", imgSrc: "/assets/custom-ai-development/svg/c73fb6786013.svg", width: "46", title: "AWS Trainium", description: " AWS chip production inference " },
    { ariahidden: "true", style: { maskImage: "url(\"/assets/custom-ai-development/svg/bbf73e985df9.svg\")" }, height: "1176", imgSrc: "/assets/custom-ai-development/svg/bbf73e985df9.svg", width: "1919", title: "NVIDIA L4", description: " Efficient choice for low-latency, cost-sensitive tasks " },
    { ariahidden: "true", style: { maskImage: "url(\"/assets/custom-ai-development/svg/bbf73e985df9.svg\")" }, height: "1176", imgSrc: "/assets/custom-ai-development/svg/bbf73e985df9.svg", width: "1919", title: "NVIDIA A100", description: " Optimized for most LLM inference workloads " },
    { style: { maskImage: "url(\"/assets/custom-ai-development/svg/bbf73e985df9.svg\")" }, height: "1176", imgSrc: "/assets/custom-ai-development/svg/bbf73e985df9.svg", width: "1919", title: "NVIDIA H100", description: " Ideal for demanding inference and training tasks " },
    { style: { maskImage: "url(\"/assets/custom-ai-development/svg/04358fc6abba.svg\")" }, height: "66", imgSrc: "/assets/custom-ai-development/svg/04358fc6abba.svg", width: "276", title: "AMD MI300X", description: " High memory bandwidth for large context windows " },
    { style: { maskImage: "url(\"/assets/custom-ai-development/svg/bbf73e985df9.svg\")" }, height: "1176", imgSrc: "/assets/custom-ai-development/svg/bbf73e985df9.svg", width: "1919", title: "NVIDIA A100", description: " Optimized for most LLM inference workloads " },
    { style: { maskImage: "url(\"/assets/custom-ai-development/svg/bbf73e985df9.svg\")" }, height: "1176", imgSrc: "/assets/custom-ai-development/svg/bbf73e985df9.svg", width: "1919", title: "NVIDIA L4", description: " Efficient choice for low-latency, cost-sensitive tasks " },
    { style: { maskImage: "url(\"/assets/custom-ai-development/svg/c73fb6786013.svg\")" }, height: "46", imgSrc: "/assets/custom-ai-development/svg/c73fb6786013.svg", width: "46", title: "AWS Trainium", description: " AWS chip production inference " },
    { ariahidden: "true", style: { maskImage: "url(\"/assets/custom-ai-development/svg/bbf73e985df9.svg\")" }, height: "1176", imgSrc: "/assets/custom-ai-development/svg/bbf73e985df9.svg", width: "1919", title: "NVIDIA H100", description: " Ideal for demanding inference and training tasks " },
    { ariahidden: "true", style: { maskImage: "url(\"/assets/custom-ai-development/svg/04358fc6abba.svg\")" }, height: "66", imgSrc: "/assets/custom-ai-development/svg/04358fc6abba.svg", width: "276", title: "AMD MI300X", description: " High memory bandwidth for large context windows " },
    { ariahidden: "true", style: { maskImage: "url(\"/assets/custom-ai-development/svg/bbf73e985df9.svg\")" }, height: "1176", imgSrc: "/assets/custom-ai-development/svg/bbf73e985df9.svg", width: "1919", title: "NVIDIA A100", description: " Optimized for most LLM inference workloads " }
];
/** The Custom AI Development page body: hero, capability blocks and case studies. */
export default function CapabilitiesSection({ logoData = Logo_data, listRow2Data = listRow2DataContent, mediaCardData = MediaCard_data } = {}) {
  return (
                ...
                <div className="min-h-100 grid pb-[78.1px] gap-y-[2.55rem] gap-x-5 grid-cols-12 max-md:min-h-101.5 max-md:pb-10 max-md:gap-y-8 max-lg:gap-x-[0.9375rem] max-md:grid-cols-1 md:max-lg:min-h-128 md:max-lg:pb-[46.3px] md:max-lg:gap-y-9 2xl:min-h-135 2xl:pb-[5.875rem] 2xl:gap-y-[2.95rem]">
                  <div className="block col-start-1 col-end-7 max-md:[grid-column-start:initial] max-md:[grid-column-end:initial]">
                    <c-split-title class="inline" id="splittitle-51">
                      {" "}
                      <div className="block font-favorit text-[5rem] font-light leading-[5rem] tracking-[-2px] max-md:text-[2.8125rem] max-md:leading-[2.8125rem] max-md:tracking-[-1.12px] md:max-lg:text-6xl md:max-lg:leading-[3.75rem] md:max-lg:tracking-[-1.49px] 2xl:text-[6.5625rem] 2xl:leading-[6.5625rem] 2xl:tracking-[-2.62px]" data-component="heading" aria-label="AI products your customers can actually buy">
                    ...
                    <div className="w-full max-w-100 flex flex-col gap-7.5">
                      <div className="block max-w-[66.8rem] leading-7 text-balance">
                        <p className="block text-[1.0625rem] font-normal leading-[1.4375rem] tracking-[0.17px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:leading-[1.375rem] max-lg:tracking-[0.16px] max-lg:[font-size:inherit]">
                          The gap between a convincing prototype and something you can charge for is mostly unglamorous. That gap is the work we do.
                        </p>
                      </div>
                      {" "}
              ...
              <div className="block max-w-500 px-10 max-lg:px-[0.9375rem]">
                <div className="grid mb-[7.5625rem] gap-5 grid-cols-2 max-lg:hidden 2xl:mb-[150.3px]">
                  <div className="block max-w-120 text-balance">
                    <p className="block text-[1.625rem] font-normal leading-[2.1875rem] tracking-[-0.64px] 2xl:text-3xl 2xl:leading-[2.5rem] 2xl:tracking-[-0.74px]">
                      Permissions, billing, cost control and the twelve edge cases strangers find.
                    </p>
                    {" "}
                  </div>
                  {" "}
                  <div className="block">
                    <c-split-title class="inline" id="splittitle-52">
                      {" "}
                      <div className="block -mt-[0.425rem] font-favorit text-[4.25rem] font-light leading-[4.4375rem] tracking-[-1.69px] 2xl:-mt-[0.55rem] 2xl:text-[5.5rem] 2xl:leading-[5.75rem] 2xl:tracking-[-2.19px]" aria-label="Why Codilated for products">
                        <div className="inline-block relative" aria-hidden="true">
                          Why
                        </div>
                        {" "}
                ...
                <c-feature-cards class="grid mb-[78.1px] gap-5 grid-cols-[590px_590px] max-md:mb-14 max-lg:gap-[0.9375rem] max-md:grid-cols-[345px] md:max-lg:mb-[4.0875rem] md:max-lg:grid-cols-[738px] 2xl:mb-[5.875rem] 2xl:grid-cols-[910px_910px]" id="featurecards-55">
                    ...
                    <div className="h-[15.7875rem] block sticky top-24.5 max-lg:h-auto max-lg:static max-lg:top-auto 2xl:h-[305.7px]">
                      ...
                      <div className="hidden mb-[78.1px] max-lg:block max-md:mb-14 md:max-lg:mb-[4.0875rem]">
                        <c-split-title class="inline" id="splittitle-53">
                          {" "}
                          <div className="block font-favorit text-[4.25rem] font-light leading-[4.4375rem] tracking-[-1.69px] max-md:text-[2.5rem] max-md:leading-10.5 max-md:tracking-[-1px] md:max-lg:text-[3.25rem] md:max-lg:leading-[3.375rem] md:max-lg:tracking-[-1.29px]" aria-label="Why Codilated for products">
                            <div className="inline-block relative" aria-hidden="true">
                              Why
                            </div>
                            {" "}
                  ...
                  <div className="grid gap-[78.1px] grid-cols-1 max-w-3xl max-md:gap-14 md:max-lg:gap-[4.0875rem] 2xl:gap-[5.875rem]">
                    <div className="block" id="prototype">
                      <c-feature-card-containers-animation class="flex flex-col gap-6" id="featurecardcontainersanimation-45">
                        ...
                        <div className="flex pr-[88.5px] flex-col gap-4 max-md:pr-0 md:max-lg:pr-[13.8375rem] 2xl:pr-[7.2rem]">
                          <h3 className="block text-[1.625rem] font-normal leading-[2.1875rem] tracking-[-0.64px] max-md:text-[1.5625rem] max-lg:font-light max-md:leading-[1.8125rem] max-md:tracking-[-0.62px] md:max-lg:text-[1.8125rem] md:max-lg:leading-[2.0625rem] md:max-lg:tracking-[-0.72px] 2xl:text-3xl 2xl:leading-[2.5rem] 2xl:tracking-[-0.74px]" data-component="heading">
                            Something real in the first weeks
                          </h3>
                          {" "}
                          <div className="block max-w-[66.8rem] leading-7">
                            <p className="block text-lg font-normal leading-[1.6875rem] tracking-[0.18px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:text-[1.0625rem] max-lg:leading-[1.625rem] max-lg:tracking-[0.17px]">
                              ...
                              <span className="inline" />
                              <span className="inline">
                                A working prototype in front of users in weeks rather than quarters, so the expensive assumptions get tested while they are still cheap to change.
                              </span>
                            </p>
                          </div>
                          {" "}
                    ...
                    <div className="block" id="multi-tenant">
                      <c-feature-card-gpu-carousel class="flex flex-col gap-6" id="featurecardgpucarousel-42">
                        ...
                        <div className="flex pr-[88.5px] flex-col gap-4 max-md:pr-0 md:max-lg:pr-[13.8375rem] 2xl:pr-[7.2rem]">
                          ...
                          <div className="block max-w-[66.8rem] leading-7">
                            <p className="block text-lg font-normal leading-[1.6875rem] tracking-[0.18px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:text-[1.0625rem] max-lg:leading-[1.625rem] max-lg:tracking-[0.17px]">
                              Authentication, roles, per-tenant isolation and billing built in from the start, because retrofitting tenancy into a working prototype is close to a rewrite.
                            </p>
                          </div>
                          {" "}
                          <div className="flex flex-wrap gap-4" />
                    ...
                    <div className="block" id="cost-control">
                      <div className="h-full flex flex-col gap-6">
                        ...
                        <div className="flex pr-[88.5px] flex-col gap-4 max-md:pr-0 md:max-lg:pr-[13.8375rem] 2xl:pr-[7.2rem]">
                          <h3 className="block text-[1.625rem] font-normal leading-[2.1875rem] tracking-[-0.64px] max-md:text-[1.5625rem] max-lg:font-light max-md:leading-[1.8125rem] max-md:tracking-[-0.62px] md:max-lg:text-[1.8125rem] md:max-lg:leading-[2.0625rem] md:max-lg:tracking-[-0.72px] 2xl:text-3xl 2xl:leading-[2.5rem] 2xl:tracking-[-0.74px]" data-component="heading">
                            Costs modelled before they bite
                          </h3>
                          {" "}
                          <div className="block max-w-[66.8rem] leading-7">
                            <p className="block text-lg font-normal leading-[1.6875rem] tracking-[0.18px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:text-[1.0625rem] max-lg:leading-[1.625rem] max-lg:tracking-[0.17px]">
                              We model cost per action before building, route easy requests to smaller models, cache at the semantic layer and cap per-tenant spend, so one heavy user cannot rewrite your margins.
                            </p>
                          </div>
                          {" "}
                          <div className="flex flex-wrap gap-4" />
                    ...
                    <div className="block" id="evaluation">
                        ...
                        <div className="flex pr-[88.5px] flex-col gap-4 max-md:pr-0 md:max-lg:pr-[13.8375rem] 2xl:pr-[7.2rem]">
                          ...
                          <div className="block max-w-[66.8rem] leading-7">
                            <p className="block text-lg font-normal leading-[1.6875rem] tracking-[0.18px] [word-break:break-word] [overflow-wrap:anywhere] max-lg:text-[1.0625rem] max-lg:leading-[1.625rem] max-lg:tracking-[0.17px]">
                              ...
                              <span className="inline" />
                              <span className="inline">
                                A prompt edit is a code change with no type system behind it. An evaluation suite runs on every one, built from real cases, and blocks the merge when it regresses.
                              </span>
                            </p>
                          </div>
                          {" "}
                    ...
                    <div className="grid gap-5 grid-cols-2 max-lg:gap-[0.9375rem] max-md:grid-cols-1">
                      <div className="block">
                        <div className="h-full flex relative p-4 rounded-[10px] gap-4 bg-background">
                          ...
                          <div className="flex flex-col justify-between grow gap-4">
                            <div className="flex flex-col gap-1.5">
                              <h3 className="block text-[1.3125rem] font-normal leading-7 tracking-[-0.52px] max-md:text-lg max-md:leading-[1.5rem] max-md:tracking-[-0.45px] md:max-lg:text-[1.1875rem] md:max-lg:leading-[1.625rem] md:max-lg:tracking-[-0.48px] 2xl:text-[1.4375rem] 2xl:leading-[1.9375rem] 2xl:tracking-[-0.57px]" data-component="heading">
                                A pricing platform, live in five weeks
                              </h3>
                              {" "}
                          ...
                          {" "}
                          <a className="w-147.5 h-full block absolute top-0 left-0 z-1 min-w-0 rounded-[10px] cursor-pointer max-md:w-[21.5625rem] md:max-lg:w-[361.5px] 2xl:w-227.5" data-component="link" href="/work" target="_blank">
                            {" "}
                    ...
                    <div className="flex mb-[2.55rem] justify-between items-center max-md:mb-8 md:max-lg:mb-9 2xl:mb-[2.95rem]">
                      <div className="block">
                        <h3 className="block text-[2.125rem] font-light leading-[2.5rem] tracking-[-0.86px] max-md:text-[1.5625rem] max-md:leading-[1.8125rem] max-md:tracking-[-0.62px] md:max-lg:text-[1.8125rem] md:max-lg:leading-[2.0625rem] md:max-lg:tracking-[-0.72px] 2xl:text-[2.5625rem] 2xl:leading-[2.9375rem] 2xl:tracking-[-1.03px]" data-component="heading">
                          Products we have taken to launch
                        </h3>
                        {" "}
                      </div>
                      {" "}
                        ...
                        <div className="flex relative flex-col h-full">
                          ...
                          <div className="flex relative z-2 p-5 justify-center items-center overflow-hidden aspect-[464/392]">
                            ...
                            <div className="w-1/2 h-[144.7px] block relative max-md:h-[95.3px] md:max-lg:h-[132.7px] 2xl:h-[14.675rem]">
                              <div className="h-full block bg-foreground" style={{ maskImage: "url(\"/assets/custom-ai-development/images/0fcf43eceab2.avif\")" }} aria-hidden="true" />
                              {" "}
