 ...
 * the document and there was nothing left to reveal. ditto.css pins it; this decides
 * when it is out of the way.
 *
 * Deliberately NOT part of DittoScroll: that component bails out entirely under
 * prefers-reduced-motion, and a navbar is a navigation control rather than
 * decoration. Here reduced motion only drops the slide (see ditto.css), so the bar
...
export default function DittoHeader() {
  useEffect(() => {
