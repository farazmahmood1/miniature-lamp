...
export const metadata = {
  "title": "Pay-Per-Second Pricing for Serverless AI | Cerebrium",
  "description": "Pay for compute by the second, not the hour. Transparent serverless GPU pricing for voice, LLMs, and video. No commitment, no idle costs.",
  "alternates": {
    "canonical": "/pricing"
  },
  "openGraph": {
    "title": "Pay-Per-Second Pricing for Serverless AI",
    "description": "Pay for compute by the second, not the hour. Transparent serverless GPU pricing for voice, LLMs, and video. No commitment, no idle costs.",
    "type": "website",
...
export default function Page() {
  return (
    <>
      ...
      {" "}
      <DittoMotion spec={{"waapi":[],"rotators":[{"anchor":"motion-1","texts":["SignEOP","SignTYA","Sign YA","Sign GC","Sign uC","Sign uD","Sign up"],"intervalMs":33}],"reveals":[{"anchor":"motion-backgroundcanvas-51","opacity":"0","transform":"none","transition":"opacity 0.3s cubic-bezier(0.4, 0, 0.2, 1)"}],"marquees":[]}} />
