...
import type { MediaCard2Styles } from "../node-styles";
  ...
  return (
    <div data-cid={cids[0]} className="block min-w-0">
      <div data-cid={cids[1]} className="flex relative p-4 rounded-[10px] gap-4 bg-surface">
          ...
          <div data-cid={cids[3]} className="block relative">
            ...
            <span data-cid={cids[5]} className="flex relative p-5 justify-center items-center aspect-square w-full">
              ...
              <div data-cid={cids[6]} className="block relative min-w-0 h-1/2 w-1/2">
                ...
                {" "}
                <img data-cid={cids[8]} className={cn("block absolute top-0 left-0 opacity-1 max-w-full overflow-clip object-contain align-middle h-full w-full", styles.className)} alt="" height={d.height} src={d.imgSrc} width={d.width} />
                {" "}
              </div>
              {" "}
            </span>
        ...
        {" "}
        <a data-cid={cids[18]} className="block absolute inset-0 z-1 min-w-0 rounded-[10px] cursor-pointer" href={d.href} target="_blank">
          {" "}
