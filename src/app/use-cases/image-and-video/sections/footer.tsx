...
/** Site footer. */
export default function Footer({ logos = Logo2_data, listRow3Data = listRow3DataContent, listRow4Data = listRow4DataContent, listRow5Data = listRow5DataContent } = {}) {
  return (
    <footer className="block relative -mt-7.5 pt-7.5 text-background">
      <div className="block relative">
        <div className="flex relative z-1 max-w-500 pt-10 px-10 flex-col gap-30 max-lg:pt-7 max-lg:px-[0.9375rem] max-lg:gap-12">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <div className="block">
                      <a className="h-13.5 min-h-13.5 inline-flex relative isolate px-5 rounded-[7px] justify-center items-center gap-2 overflow-hidden text-color-001 bg-primary cursor-pointer max-lg:h-10.5 max-lg:min-h-10.5 max-lg:px-3.5" data-component="link" href="https://dashboard.cerebrium.ai/signup" rel="noopener noreferrer" target="_blank">
                        {" "}
                        <c-scramble-text class="block z-2 font-suisse-mono text-[0.8125rem] font-normal leading-[0.8125rem] tracking-[-0.32px] uppercase" id="scrambletext-36">
                          {" Get started "}
                        </c-scramble-text>
                        {" "}
                      </a>
                    ...
                    <div className="block">
                      <a className="h-13.5 min-h-13.5 inline-flex relative isolate px-5 rounded-[7px] justify-center items-center gap-2 overflow-hidden bg-clr-1 [backdrop-filter:blur(16px)] cursor-pointer max-lg:h-10.5 max-lg:min-h-10.5 max-lg:px-3.5" data-component="link" href="/book-demo" target="_self">
                        {" "}
                        <c-scramble-text class="block z-2 font-suisse-mono text-[0.8125rem] font-normal leading-[0.8125rem] tracking-[-0.32px] uppercase" id="scrambletext-37">
                          {" Book a demo "}
                        </c-scramble-text>
                        {" "}
                      </a>
          ...
          {" "}
          <div className="border-t border-solid border-t-clr-6 grid py-7.5 gap-5 grid-cols-12 max-lg:items-end max-lg:gap-y-2 max-lg:gap-x-[0.9375rem] max-md:grid-cols-2">
