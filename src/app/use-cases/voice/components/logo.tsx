...
/** A logo. */
export default function Logo({ d, meta, styles }: { d: LogoData; meta: DittoNodeMetaMap; styles: LogoStyles }) {
  return (
    <div data-ditto-id={meta[0]?.anchor} className={cn("w-[196.7px] h-[196.7px] flex absolute rounded-[10px] justify-center items-center overflow-hidden aspect-square origin-[98.3281px_98.3281px] max-md:w-[7.1875rem] max-md:h-[7.1875rem] md:max-lg:w-[15.375rem] md:max-lg:h-[15.375rem] 2xl:w-64 2xl:h-64 2xl:origin-[127.992px_127.992px]", styles.className)} aria-hidden={d.ariahidden}>
      <div data-ditto-id={meta[1]?.anchor} className="h-full flex p-[19.7px] justify-center items-center aspect-square max-md:p-[11.5px] md:max-lg:p-[1.5375rem] 2xl:p-[1.6rem]">
