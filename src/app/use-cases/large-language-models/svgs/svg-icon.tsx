export default function Icon({ dittoId }: { dittoId?: string }) {
  return (
    <svg className="w-auto h-[0.6875rem] block overflow-hidden align-middle pointer-events-none" aria-hidden="true" height="1em" viewBox="0 0 11 11" width="1em" focusable="false" data-icon="menu" fill="currentColor" data-ditto-id={dittoId}>
