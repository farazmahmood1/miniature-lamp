export default function Icon6({ dittoId }: { dittoId?: string }) {
  return (
    <svg className="w-6 h-6 block overflow-hidden align-middle" data-component="icon" viewBox="0 0 256 256" fill="currentColor" data-ditto-id={dittoId}>
