export default function Icon4({ dittoId }: { dittoId?: string }) {
  return (
    <svg className="w-5 h-5 block overflow-hidden align-middle pointer-events-none focus:outline-clr-5 focus:[outline-style:auto] focus:outline-[5px]" data-component="icon" viewBox="0 0 256 256" fill="currentColor" data-ditto-id={dittoId}>
