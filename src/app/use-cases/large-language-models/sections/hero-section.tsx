  ...
  return (
    ...
    >
      <picture>
        ...
        <source media="(max-width: 571px)" srcSet="/assets/llm/images/globe-375.webp" />
        <source media="(max-width: 1024px)" srcSet="/assets/llm/images/globe-768.webp" />
        <source media="(min-width: 1601px)" srcSet="/assets/llm/images/globe-1920.webp" />
        <img
          ...
          height="800"
          src="/assets/llm/images/globe-1280.webp"
          width="1280"
          alt=""
          fetchPriority="high"
        />
