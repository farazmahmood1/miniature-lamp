...
export default function MediaCard({ d, styles }: { d: MediaCardData; styles: MediaCardStyles }) {
  return (
    <div className={cn("w-[25.8125rem] h-[137.9px] block absolute origin-[206.5px_68.9453px] max-md:w-69 md:max-lg:w-[32.2875rem] md:max-lg:h-[10.5625rem] 2xl:w-[33.6rem] 2xl:h-[175.3px] 2xl:origin-[268.797px_87.6328px]", styles.className)} aria-hidden={d.ariahidden}>
      <div className="h-full flex relative p-2.5 rounded-[10px] items-center gap-5 overflow-hidden bg-background">
        <div className="flex rounded-[10px] justify-center items-center shrink-0 basis-[30%] overflow-hidden aspect-square bg-primary">
        ...
        {" "}
        <div className={cn("w-[25.8125rem] h-full block absolute top-0 left-0 min-w-0 bg-surface pointer-events-none 2xl:w-[33.6rem]", styles.className3)} />
        {" "}
      </div>
      {" "}
    </div>
